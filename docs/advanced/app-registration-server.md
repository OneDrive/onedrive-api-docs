# Registering your app for SharePoint Server 2016
...
For information on how to authenticate, see [OneDrive for Business authentication and sign in](auth/aad_oauth.md).
