...
function initializeDemo() {
    ...
    pickerHtml += "<span class='cell'>";
    pickerHtml += "<input id='webViewLink' type='radio' value='webViewLink' name='linkType' checked='checked' />";
    pickerHtml += "<label for='webViewLink'>Web View Link</label><br />";
    pickerHtml += "<input id='downloadLink' type='radio' value='downloadLink' name='linkType' />";
    ...
    var openPickerHeader = document.getElementById("opening-files-on-onedrive");
    ...
    var saverPickerHeader = document.getElementById("saving-files-to-onedrive");
