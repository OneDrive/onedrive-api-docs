...
| **accountSwitchEnabled** | A boolean indicating whether or not the "Switch account" UI should render on the hosted File Picker page. By default the value is `true` and the UI is shown. |
