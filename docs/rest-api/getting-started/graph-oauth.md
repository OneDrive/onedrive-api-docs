...
For more information see [App authentication with Microsoft Graph](https://developer.microsoft.com/en-us/graph/docs/concepts/auth_overview).
...
* [App authentication with Microsoft Graph](https://developer.microsoft.com/en-us/graph/docs/concepts/auth_overview)
