...
If you are unsure about which approach to use, see [Deciding between Azure AD and Azure AD v2.0 endpoints](https://developer.microsoft.com/en-us/graph/docs/concepts/auth_overview#deciding-between-the-azure-ad-and-azure-ad-v20-endpoints).
