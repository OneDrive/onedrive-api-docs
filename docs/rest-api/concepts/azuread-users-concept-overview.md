...
- Learn more about how to [work with users](../resources/users.md).
...
- Set access control and policies for users with the [Azure AD API](../resources/azure_ad_overview.md).
