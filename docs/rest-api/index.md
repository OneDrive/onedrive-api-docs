...
To quickly experiment with Microsoft Graph and accessing files, check out the [Graph Explorer](https://developer.microsoft.com/en-us/graph/graph-explorer) and the [Microsoft Graph Quick Start](https://developer.microsoft.com/en-us/graph/quick-start).
...
[graph-user]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/resources/users
[graph-group]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/resources/group
[graph-site]: https://developer.microsoft.com/en-us/graph/docs/api-reference/v1.0/resources/site
