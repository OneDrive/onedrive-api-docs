...
> [!IMPORTANT]  
> These terms of use are obsolete and have been archived. They do not reflect current best practices for API terms of use. If you’re looking for current API terms of use, see [Microsoft Terms of Use](/legal/termsofuse) or other API terms of use applied to Microsoft online services.
