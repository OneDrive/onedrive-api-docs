...
<!-- { "blockType": "request", "name": "add-mountpoint", "@odata.type": "oneDrive.item", "truncated": true} -->
```http
...
<!-- { "blockType": "request", "name": "delete-mountpoint" } -->
```http
...
<!-- { "blockType": "request", "name": "enum-mountpoint" } -->
```http
