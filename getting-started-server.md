...
OneDrive prefers using [OAuth 2.0](http://oauth.net/2/) for [authorization / authentication](auth/readme.md).
...
Now that you've authenticated your app, you can call the OneDrive API with your access token against the URL root below, combined with one of the [root resources](README.md#onedrive-root-resources).
...
Read through the [OneDrive API HTTP documentation](README.md) to learn more about working with the [**drive**](resources/drive.md) and [**item**](resources/item.md) resources in OneDrive API HTTP end point.
